...
def get_berlin():
	...
	params = {
		...
		"hourly": ["temperature_2m", "precipitation", "rain", "snowfall", "relative_humidity_2m", "wind_speed_10m", "wind_speed_120m"],
		"past_days": 92
	}
...
def get_amsterdam():
	...
	try: 
		ResultBytes = urllib.request.urlopen(f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Amsterdam%2C%20Noord-Holland%2C%20Nederland/2025-02-1/2025-03-13?unitGroup=us&key={api_key}&contentType=json")
